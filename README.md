# HistoryDog Privacy Policy

本仓库托管“历史汪 / HistoryDog”浏览器扩展的中英文公开隐私政策，供 Microsoft Edge Add-ons、Chrome Web Store 和其他公开渠道引用。
...
- 可选的 DeepSeek 查询规划与结果精排
- 发送给 AI 服务的数据范围和明确排除的数据
- 数据保留、删除、第三方共享和用户控制
